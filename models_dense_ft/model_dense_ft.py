...
def weight_init_dense_transfer(
    ...
    if finetuning_percentage == 0:
        ...
        model = keras.models.load_model(
            f"../models_saved/base_models/{from_building_name.lower()}{from_tower_number}_{from_season}_lstm/"
        )
    ...
    # if finetuning is required
        ...
        model_path = f"{rootpath}/models_saved/dense_ft/{from_building_name.lower()}{from_tower_number}{from_season}_to_{to_building_name.lower()}{to_tower_number}{to_season}_ft{int(finetuning_percentage*100)}_seed{shuffle_seed}/"
